...
import { getGridLayout } from "../../utils/layouts/gridLayout";
...
export const GridView = ({ nodes, edges, searchResults }: GridViewProps) => {
  ...
  useEffect(() => {
    ...
    const calculateLayout = async () => {
      ...
      const { nodes: layoutedNodes, edges: layoutedEdges } = getGridLayout(
        nodes,
        edges,
        {
          columns: 10,
